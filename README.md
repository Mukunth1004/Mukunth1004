...
<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=500&size=17&duration=3200&pause=900&color=58A6FF&center=true&vCenter=true&width=680&lines=Building+production-grade+systems+end-to-end;7+microservices+%E2%80%A2+99.8%25+uptime+%E2%80%A2+1%2C000%2B+RPM;Transformer+Inference+%7C+ONNX+%7C+RAG+Pipelines;Kubernetes+%E2%80%A2+FastAPI+%E2%80%A2+PyTorch+%E2%80%A2+GitLab+CI%2FCD" />
</p>

<p align="center">

[![Profile Views](https://komarev.com/ghpvc/?username=Mukunth1004&style=flat-square&color=58a6ff&label=Profile+Views)](https://github.com/Mukunth1004)
&nbsp;
[![Gmail](https://img.shields.io/badge/Email-EA4335?style=flat-square&logo=gmail&logoColor=white)](mailto:mukunth.s1004@gmail.com)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=flat-square&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/s-mukunth1004)
...
```
🏗️  K3s clusters  →  7 microservices  →  99.8% uptime  →  zero-downtime migrations
🤖  DistilBERT fine-tuned  →  ONNX export  →  40% faster inference  →  1,000+ RPM
📡  RAG platform  →  pgvector  →  sub-500ms vector search  →  60% fewer API calls
⚙️  GitLab CI/CD  →  27 jobs  →  Helm  →  Dev / UAT / Production
```
...
<table align="center">
  <tr>
    <td align="center" width="175">
      <h4>🤖 AI / ML</h4>
      <sub>Transformer fine-tuning<br/>ONNX graph optimization<br/>RAG pipelines · pgvector</sub>
    </td>
    <td align="center" width="175">
      <h4>⚙️ Backend</h4>
    ...
    <td align="center" width="175">
      <h4>🌐 Full Stack</h4>
      <sub>React.js · Next.js<br/>TypeScript · Redux<br/>SSR/CSR · TailwindCSS</sub>
    </td>
  </tr>
</table>
...
|:--------|:------------|:---------|:------:|
| **MyBuildGuide** | Construction SaaS · 7 microservices · K3s | App Store · Play Store | ![Live](https://img.shields.io/badge/Live-2ea44f?style=flat-square) |
| **[Portfolio](https://mukunthan-portfolio-z7if.vercel.app/)** | Personal portfolio · Next.js | Vercel | ![Online](https://img.shields.io/badge/Online-58a6ff?style=flat-square) |
